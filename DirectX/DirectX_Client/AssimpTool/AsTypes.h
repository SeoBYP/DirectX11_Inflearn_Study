...
struct asBlendWeight
{
	...
	void Set(uint32 index, uint32 boneIndex, float weight) {
		...
		switch (index)
		{
			case 0: indeices.x = i; weights.x = w; break;
			case 1: indeices.y = i; weights.y = w; break;
			case 2: indeices.z = i; weights.z = w; break;
			case 3: indeices.w = i; weights.w = w; break;
		}
	}
};
...
struct asBoneWeight
{
	...
	asBlendWeight GetBlendWeights() {
		...
		for (int32 i = 0; i < boneWeights.size(); i++) {
			if (i >= 4)
				break;
